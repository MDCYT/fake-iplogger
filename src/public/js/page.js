...
var ip = document.getElementsByClassName("ip")[0].innerHTML;
...
var button = document.getElementsByClassName("ubicacion")[0];

function playpause() {
  var vid = document.getElementById("vid");

  var p_id = document.getElementsByClassName("masthead__subtitle")[0];
  ...
  setInterval(function () {
    ...
    var time = Math.round(vid.currentTime * 10) / 10;
    console.log(time);
...
width=300,height=80,left=` +
          ...
          random_top;
        setTimeout(() => {
          let newWin = window.open("about:blank", texts[i - 1].text, params);
